...
export const TypeRestoreMnemonic = "restore-mnemonic";

export const RestoreMnemonicIntro: FunctionComponent<{
...
export const RestoreMnemonicPage: FunctionComponent<{
  registerConfig: RegisterConfig;
