...
export const ModalBase: FunctionComponent<ModalBaseProps> = ({
  ...
  const openCallbackOnce = useSharedValue(0);
  const closeCallbackOnce = useSharedValue(0);
  ...
  const openVelocityValue = useSharedValue(0);
  const closeVelocityValue = useSharedValue(0);
